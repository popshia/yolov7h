...
def non_max_suppression(
    ...
    # REVIEW: change pred.shape and conf index from 5->6, 4->5
    ...
    for xi, x in enumerate(prediction):  # image index, image inference
        ...
        if multi_label:
            # REVIEW: tweak index and add rad
...
def single_xywhrad2poly(box, width=-1, height=-1, denormalize=True):
    ...
    center, w, h, rad = (
        ...
        clone_box[2],
        clone_box[3],
        clone_box[4] * math.pi * 2 + math.pi / 2,
    )
